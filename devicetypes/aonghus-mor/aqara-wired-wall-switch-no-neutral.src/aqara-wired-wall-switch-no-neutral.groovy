 ...
 *  13.10.2020 New version by @aonghus-mor for new smartthings app.
*/
...
def parse(String description)
{
    ...
    */
    ...
    events << createEvent(name: "lastCheckin", value: now, descriptionText: "Check-In now!", displayed: debugLogging)
